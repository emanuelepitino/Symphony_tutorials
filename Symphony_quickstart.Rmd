...
# Path
```{r}
path_main <- "/Users/emanuele/Desktop/Symphony_tutorial"
```
...
```{r}
load(paste0(path_main,"/data_quickstart/pbmcs_exprs_small.rda"))
load(paste0(path_main,"/data_quickstart/pbmcs_meta_small.rda"))
...
reference = buildReferenceFromHarmonyObj(
                        ...
                        save_uwot_path =  paste0(path_main,"/data_quickstart/testing_uwot_model_1")) # file path to save uwot model
```

Save Symphony reference for later mapping (modify with your desired output path)
```{r}
saveRDS(reference, paste0(path_main,"/data_quickstart/testing_reference1.rds"))
```
...
reference = readRDS(paste0(path_main,"/data_quickstart/testing_reference1.rds"))
